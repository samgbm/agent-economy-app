...
async function main() {
  const API_URL = "http://localhost:3000/api/router";
  const payload = { service_id: "8727002e-32aa-4fb4-aef9-e2f6a555817a", payload: { query: "Explain the NWC Wallet Connect to a 5 year old in one sentence." } };
